...
from models import Encoder, DecoderWithAttention, TitleEncoder
...
data_name = 'atlas_1_cap_per_img_20_min_word_freq'  # base name shared by data files

# Model parameters
emb_dim = 256  # dimension of word embeddings
attention_dim = 512  # dimension of attention linear layers
title_attention_dim = 512
title_encoder_dim = 512
title_embedding_dim = 256
